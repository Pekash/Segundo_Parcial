        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <a href="http://localhost/Semana4/Z1" class="btn btn-primary btn-lg w-100">Zapatos Deportivos</a>
                    </div>
                    <div class="col-md-6">
                        <a href="http://localhost/Semana4/Z2" class="btn btn-primary btn-lg w-100">Zapatos Casuales</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <a href="http://localhost/Semana4/V1" class="btn btn-success btn-lg w-100">Vestidos de Fiesta</a>
                    </div>
                    <div class="col-md-6">
                        <a href="http://localhost/Semana4/V2" class="btn btn-success btn-lg w-100">Vestidos Formales</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <a href="http://localhost/Semana4/C1" class="btn btn-warning btn-lg w-100">Carteras de Mano</a>
                    </div>
                    <div class="col-md-6">
                        <a href="http://localhost/Semana4/C2" class="btn btn-warning btn-lg w-100">Carteras de Hombro</a>
                    </div>
                </div>
            </div>
        </div>
